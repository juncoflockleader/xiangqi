...
function createLessonCard(move, rank) {
  ...
  return {
    ...
    playedScore: Math.round(move.review.playedScore ?? 0),
    playedScoreDetail: move.review.playedScoreDetail ?? null,
    playedScoreText: move.review.playedScoreDetail?.text ?? formatCentipawns(move.review.playedScore),
    playedWdl: move.review.playedWdl ?? null,

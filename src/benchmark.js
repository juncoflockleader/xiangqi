...
export const ENGINE_OPENING_ORACLE_BENCHMARKS = Object.freeze([
  ...
  Object.freeze({
    ...
    lesson: "When Black challenges the early pawn, the native engine should keep Pikafish's refreshed cannon regroup and near-tie horse-development moves ahead of shallow flank play."
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    expectedMoves: Object.freeze(["h9-h3", "c6-c5", "h9-h5", "b9-c7"]),
    tags: Object.freeze(["opening", "oracle", "pikafish", "native", "regression", "central-cannon"]),
    options: Object.freeze({
      depth: 8,
      timeLimitMs: 1000,
    ...
    lesson: "With both rooks lifted, the native engine should prefer the refreshed quiet rook lift or close pawn challenge before lower-value pressure plans."
  }),
  Object.freeze({

...
function formatGoResult(result) {
  ...
  outputs.push(
    `info depth ${result.depth} score cp ${Math.round(result.score)} nodes ${result.nodes} qnodes ${stats.qnodes ?? 0} qchecks ${stats.qchecks ?? 0} qtthits ${stats.qttHits ?? 0} qttstores ${stats.qttStores ?? 0} qttevict ${stats.qttEvictions ?? 0} qttmove ${stats.qttMoveHits ?? 0} evalhits ${stats.evalCacheHits ?? 0} evalstores ${stats.evalCacheStores ?? 0} tacthits ${stats.tacticalCacheHits ?? 0} tactstores ${stats.tacticalCacheStores ?? 0} tactord ${stats.tacticalMoveOrderHits ?? 0} tthits ${stats.ttHits ?? 0} ttmove ${stats.ttMoveHits ?? 0} ttstores ${stats.ttStores ?? 0} ttevict ${stats.ttEvictions ?? 0} asp ${stats.aspirationSearches ?? 0} aspwide ${stats.aspirationWidenedSearches ?? 0} asphi ${stats.aspirationFailHigh ?? 0} asplo ${stats.aspirationFailLow ?? 0} ext ${stats.extensions ?? 0} recext ${stats.recaptureExtensions ?? 0} singtry ${stats.singularExtensionSearches ?? 0} singext ${stats.singularExtensions ?? 0} soft ${stats.softStops ?? 0} see ${stats.seePrunes ?? 0} lacache ${stats.leastAttackerCacheHits ?? 0}/${stats.leastAttackerCacheProbes ?? 0} lastores ${stats.leastAttackerCacheStores ?? 0} rfp ${stats.reverseFutilityPrunes ?? 0} mdp ${stats.mateDistancePrunes ?? 0} razor ${stats.razorPrunes ?? 0} pcut ${stats.probCutPrunes ?? 0} pcsearch ${stats.probCutSearches ?? 0} futil ${stats.futilityPrunes ?? 0} hprune ${stats.badHistoryPrunes ?? 0} hpguard ${stats.badHistoryPruneGuards ?? 0} lmp ${stats.lateMovePrunes ?? 0} lmp3 ${stats.depthThreeLateMovePrunes ?? 0} delta ${stats.deltaPrunes ?? 0} nmp ${stats.nullMovePrunes ?? 0} nmv ${stats.nullMoveVerifications ?? 0} nmvfail ${stats.nullMoveVerificationFailures ?? 0} killer ${stats.killerStores ?? 0} killerhit ${stats.killerHits ?? 0} caphist ${stats.captureHistoryHits ?? 0} checkhist ${stats.checkHistoryHits ?? 0} checkhm ${stats.checkHistoryMaluses ?? 0} checkcache ${stats.checkCacheHits ?? 0}/${stats.checkCacheStores ?? 0} red ${stats.reductions ?? 0} redply ${stats.reductionPlies ?? 0} deepred ${stats.deepReductions ?? 0} pvguard ${stats.pvReductionGuards ?? 0} cutred ${stats.cutNodeReductionBoosts ?? 0} imp ${stats.improvingNodes ?? 0} nimp ${stats.nonImprovingNodes ?? 0} imprd ${stats.improvingReductionGuards ?? 0} nimprd ${stats.nonImprovingReductionBoosts ?? 0} implmp ${stats.improvingLateMoveGuards ?? 0} nimlmp ${stats.nonImprovingLateMovePrunes ?? 0} cm ${stats.countermoveHits ?? 0} ch ${stats.continuationHistoryHits ?? 0} chred ${stats.continuationReductionBoosts ?? 0} chredm ${stats.continuationReductionMaluses ?? 0} ce ${stats.checkEvasionOrderHits ?? 0} cecap ${stats.checkEvasionCaptures ?? 0} ceblock ${stats.checkEvasionBlocks ?? 0} ceking ${stats.checkEvasionKingMoves ?? 0} hmalus ${stats.historyMaluses ?? 0} hgrav ${stats.historyGravityUpdates ?? 0} rootord ${stats.rootScoreOrderHits ?? 0} rootrank ${stats.rootRankOrderHits ?? 0} rootstate ${stats.rootChildStateReuses ?? 0} rootred ${stats.rootReductions ?? 0}/${stats.rootReductionResearches ?? 0} rootredply ${stats.rootReductionPlies ?? 0} rootsee ${stats.rootBadCaptureReductions ?? 0} roothrguard ${stats.rootHistoryReductionGuards ?? 0} roothrboost ${stats.rootHistoryReductionBoosts ?? 0} tguard ${stats.rootTimeGuardStops ?? 0} iid ${stats.iidSearches ?? 0} iidhit ${stats.iidMoveHits ?? 0} rootmoves ${stats.rootMovesSearched ?? 0} pvs ${stats.pvsResearches ?? 0} pv ${pv}`,

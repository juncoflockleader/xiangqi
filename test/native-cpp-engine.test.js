...
test("local C++ timed opening priors guide pure native central cannon branches", async (t) => {
  ...
  try {
    ...
    assert.equal(moveToNotation(centralCannonEarlyPawnBlackResult.bestMove), "h2-i2");

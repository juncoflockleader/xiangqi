...
test("local C++ engine builds and searches through the native UCI backend", async (t) => {
  ...
  try {
    ...
    assert.ok(result.raw.some((line) => /\bext\b/.test(line) && /\brecext\b/.test(line) && /\bpawnext\b/.test(line) && /\brecorder\b/.test(line) && /\bqnodes\b/.test(line) && /\bqchecks\b/.test(line) && /\bqcheckhist\b/.test(line) && /\bqcheckhstores\b/.test(line) && /\bqcheckhm\b/.test(line) && /\bqcapguard\b/.test(line) && /\bqcaphist\b/.test(line) && /\bqcapstores\b/.test(line) && /\bqcaphm\b/.test(line)));

...
test("UCCI session searches a FEN position", () => {
  ...
  assert.ok(output.some((line) => /\bttmove \d+/.test(line)));
  assert.ok(output.some((line) => /\baspwide \d+/.test(line)));
  ...
  assert.ok(output.some((line) => /\bhprune \d+/.test(line)));
  assert.ok(output.some((line) => /\bhpguard \d+/.test(line)));
  ...
  assert.ok(output.some((line) => /\bpvguard \d+/.test(line)));
  assert.ok(output.some((line) => /\bcutred \d+/.test(line)));
  assert.ok(output.some((line) => line.includes("hmalus")));
  assert.ok(output.some((line) => /\bhgrav \d+/.test(line)));
  assert.ok(output.some((line) => /\bimp \d+/.test(line)));
  assert.ok(output.some((line) => /\bnimp \d+/.test(line)));
  assert.ok(output.some((line) => /\bimprd \d+/.test(line)));
  assert.ok(output.some((line) => /\bnimprd \d+/.test(line)));
  assert.ok(output.some((line) => /\bimplmp \d+/.test(line)));
  assert.ok(output.some((line) => /\bnimlmp \d+/.test(line)));
  assert.ok(output.some((line) => /\brootstate \d+/.test(line)));
  assert.ok(output.some((line) => /\brootred \d+\/\d+/.test(line)));
  assert.ok(output.some((line) => /\brootredply \d+/.test(line)));
  assert.ok(output.some((line) => /\brootsee \d+/.test(line)));
  assert.ok(output.some((line) => /\btguard \d+/.test(line)));

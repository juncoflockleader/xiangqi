...
- Zobrist hashing, bounded depth-preferred transposition table, aspiration windows, quiescence search with bounded quiet-check search and delta pruning, capture/check/positive and negative history/countermove/continuation-history/root-score/internal-iterative-deepening move ordering, mate-distance pruning, bounded check, recapture, and singular extensions, static-exchange pruning, ProbCut capture pruning, shallow razoring, guarded and verified null-move pruning, shallow futility pruning, adaptive late-move reductions, repetition diagnostics, and root candidate analysis.

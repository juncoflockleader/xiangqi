  ...
  if (command === "ucci") {
    ...
    const respond = () => {
      if (hasOption("MockMateWdl")) {
        ...
        write(`info depth ${depth} seldepth ${depth + 4} score cp 42 nodes 123 qnodes 44 time 15 nps 8200 hashfull 321 string tt 5/9 cutoffs 2 ttmove 6 ttpref 33 killers 3 history 4 caphist 12 caphstores 5 caphm 7 caphguard 2 nmp 1 nmv 2 nmvfail 1 nmmguard 6 rfp 9 mdp 2 razor 4/1 see 3 see3 2 lacache 13/21 lastores 8 pcut 2 pcsearch 7 pcskip 8 futil 6 hprune 5 hpguard 2 delta 12 qdskip 15 qsee 13 qseepf 9 lmp 4 lmp3 2 lmp4 1 lmr 7/2 redply 11 deepred 3 pvguard 5 cutboost 6 imp 10 nimp 4 imprd 2 nimprd 3 implmp 1 nimlmp 2 cm 6 cmstores 7 ch 8 chstores 11 chred 3 chredm 1 fch 9 fchstores 10 fchred 4 fchredm 2 ce 18 cecap 4 ceblock 9 ceking 5 checkhist 14 checkhstores 9 checkhm 2 checkcache 21/34 iid 4 iidcut 2 iidhit 3 rootmoves 12 rootstate 24 rootred 5/2 rootsee 3 rootredply 7 roothrguard 4 roothrboost 5 roottt 1 rootttstores 3 rootord 7 rootordstores 8 pvs 3 asp 5 aspwide 2 asphi 1 asplo 2 tguard 4 opref 6 ext 8 recext 1 pawnext 2 pawnord 3 singtry 4 singext 2 singrej 1 qchecks 5 qcheckhist 6 qcheckhstores 9 qcheckhm 4 qcapguard 3 qcaphist 10 qcapstores 11 qcaphm 12 qtt 11/13 qttstores 17 qttcut 3 qttmove 2 qttpref 22 eval 19/23 evalstores 29 evalpref 44 evalskip 31 evalguard 4 rep 2 memage 3 pv ${nativeMove("h9g7")} ${nativeMove("h0g2")}`);
        write(`bestmove ${nativeMove("h9g7")}`);
        ...
        write(`bestmove ${nativeMove("h9g7")}`);
      } else if (hasOption("MockOpeningPreference")) {
